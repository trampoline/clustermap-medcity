...
{var iter__4377__auto__ = (function iter__29597(s__29598){return (new cljs.core.LazySeq(null,(function (){var s__29598__$1 = s__29598;while(true){
...
{var path__$1 = cljs.core._nth.call(null,c__4375__auto__,i__29599);cljs.core.chunk_append.call(null,b__29600,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
...
{var path__$1 = cljs.core.first.call(null,s__29598__$2);return cljs.core.cons.call(null,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
{var sp = temp__4126__auto____$1;return cljs.core.get_in.call(null,cursor,clustermap.components.mount.make_sequential.call(null,path__$1));
} else
{return null;
}
...
{return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4377__auto__ = (function iter__29601(s__29602){return (new cljs.core.LazySeq(null,(function (){var s__29602__$1 = s__29602;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__29602__$1);if(temp__4126__auto__)
{var s__29602__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__29602__$2))
{var c__4375__auto__ = cljs.core.chunk_first.call(null,s__29602__$2);var size__4376__auto__ = cljs.core.count.call(null,c__4375__auto__);var b__29604 = cljs.core.chunk_buffer.call(null,size__4376__auto__);if((function (){var i__29603 = (0);while(true){
if((i__29603 < size__4376__auto__))
{var vec__29607 = cljs.core._nth.call(null,c__4375__auto__,i__29603);var key = cljs.core.nth.call(null,vec__29607,(0),null);var path__$1 = cljs.core.nth.call(null,vec__29607,(1),null);cljs.core.chunk_append.call(null,b__29604,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
...
{var vec__29608 = cljs.core.first.call(null,s__29602__$2);var key = cljs.core.nth.call(null,vec__29608,(0),null);var path__$1 = cljs.core.nth.call(null,vec__29608,(1),null);return cljs.core.cons.call(null,(function (){var temp__4126__auto____$1 = cljs.core.not_empty.call(null,clustermap.components.mount.make_sequential.call(null,path__$1));if(cljs.core.truth_(temp__4126__auto____$1))
{var sp = temp__4126__auto____$1;return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [key,cljs.core.get_in.call(null,cursor,sp)], null);
} else
{return null;
}
...
var mount__delegate = function (cname,f,value,p__29611){var map__29613 = p__29611;var map__29613__$1 = ((cljs.core.seq_QMARK_.call(null,map__29613))?cljs.core.apply.call(null,cljs.core.hash_map,map__29613):map__29613);var options = map__29613__$1;var paths = cljs.core.get.call(null,map__29613__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));var path = cljs.core.get.call(null,map__29613__$1,new cljs.core.Keyword(null,"path","path",-188191168));var target = cljs.core.get.call(null,map__29613__$1,new cljs.core.Keyword(null,"target","target",253001721));var target__$1 = (((typeof target === 'string') || ((target instanceof cljs.core.Keyword)))?document.getElementById(cljs.core.name.call(null,target)):target);var cursor_fn = cljs.core.partial.call(null,clustermap.components.mount.extract_paths,cname,path,paths);var options__$1 = cljs.core.assoc.call(null,cljs.core.assoc.call(null,cljs.core.dissoc.call(null,options,new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.Keyword(null,"paths","paths",-1807389588)),new cljs.core.Keyword(null,"target","target",253001721),target__$1),new cljs.core.Keyword(null,"fn","fn",-1175266204),cursor_fn);if(cljs.core.truth_(target__$1))
...
var p__29611 = null;if (arguments.length > 3) {
  p__29611 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3),0);} 
return mount__delegate.call(this,cname,f,value,p__29611);};
mount.cljs$lang$maxFixedArity = 3;
mount.cljs$lang$applyTo = (function (arglist__29614){
var cname = cljs.core.first(arglist__29614);
arglist__29614 = cljs.core.next(arglist__29614);
var f = cljs.core.first(arglist__29614);
arglist__29614 = cljs.core.next(arglist__29614);
var value = cljs.core.first(arglist__29614);
var p__29611 = cljs.core.rest(arglist__29614);
return mount__delegate(cname,f,value,p__29611);
});
...
var unmount__delegate = function (p__29615){var map__29617 = p__29615;var map__29617__$1 = ((cljs.core.seq_QMARK_.call(null,map__29617))?cljs.core.apply.call(null,cljs.core.hash_map,map__29617):map__29617);var target = cljs.core.get.call(null,map__29617__$1,new cljs.core.Keyword(null,"target","target",253001721));var name = cljs.core.get.call(null,map__29617__$1,new cljs.core.Keyword(null,"name","name",1843675177));var target__$1 = (((typeof target === 'string') || ((target instanceof cljs.core.Keyword)))?document.getElementById(name.call(null,target)):target);if(cljs.core.truth_(target__$1))
...
var p__29615 = null;if (arguments.length > 0) {
  p__29615 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return unmount__delegate.call(this,p__29615);};
unmount.cljs$lang$maxFixedArity = 0;
unmount.cljs$lang$applyTo = (function (arglist__29618){
var p__29615 = cljs.core.seq(arglist__29618);
return unmount__delegate(p__29615);
});
