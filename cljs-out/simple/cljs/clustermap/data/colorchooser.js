...
return (function (p__29660){var vec__29661 = p__29660;var t = cljs.core.nth.call(null,vec__29661,(0),null);var i = cljs.core.nth.call(null,vec__29661,(1),null);return (value <= t);
});})(scheme_thresholds))
...
clustermap.data.colorchooser.choose_color_scheme = (function choose_color_scheme(color_scheme_spec){var vec__29663 = color_scheme_spec;var k = cljs.core.nth.call(null,vec__29663,(0),null);var rest = cljs.core.nthnext.call(null,vec__29663,(1));if((k instanceof cljs.core.Keyword))
...
*/
clustermap.data.colorchooser.choose = (function choose(color_scheme_spec,scale,key,variable,data){var color_scheme = clustermap.data.colorchooser.choose_color_scheme.call(null,color_scheme_spec);var col_count = cljs.core.count.call(null,color_scheme);var values = cljs.core.filter.call(null,cljs.core.identity,clustermap.data.picker.pick_variable.call(null,variable,data));var min_value = cljs.core.apply.call(null,cljs.core.min,values);var max_value = cljs.core.apply.call(null,cljs.core.max,values);var thresholds = (function (){var pred__29667 = cljs.core._EQ_;var expr__29668 = scale;if(cljs.core.truth_(pred__29667.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),expr__29668)))
{return clustermap.data.colorchooser.log_scale.call(null,min_value,max_value,col_count);
} else
{if(cljs.core.truth_(pred__29667.call(null,new cljs.core.Keyword(null,"linear","linear",872268697),expr__29668)))
{return clustermap.data.colorchooser.linear_scale.call(null,min_value,max_value,col_count);
} else
{if(cljs.core.truth_(pred__29667.call(null,new cljs.core.Keyword(null,"auto","auto",-566279492),expr__29668)))
{return clustermap.data.colorchooser.auto_scale.call(null,col_count,values);
} else
{if(cljs.core.truth_(pred__29667.call(null,new cljs.core.Keyword(null,"auto-no-outliers","auto-no-outliers",-1448217833),expr__29668)))
{return clustermap.data.colorchooser.auto_no_outliers_scale.call(null,col_count,(5),values);
} else
{throw (new Error(("No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__29668))));
}
}
}
}
