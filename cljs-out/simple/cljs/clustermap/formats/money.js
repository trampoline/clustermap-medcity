...
var readable__delegate = function (n,p__27855){var map__27858 = p__27855;var map__27858__$1 = ((cljs.core.seq_QMARK_.call(null,map__27858))?cljs.core.apply.call(null,cljs.core.hash_map,map__27858):map__27858);var default$ = cljs.core.get.call(null,map__27858__$1,new cljs.core.Keyword(null,"default","default",-1987822328));var plus_QMARK_ = cljs.core.get.call(null,map__27858__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327));var curr = cljs.core.get.call(null,map__27858__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"\u00A3");var sf = cljs.core.get.call(null,map__27858__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738));if((typeof n === 'number') && (cljs.core.not.call(null,isNaN(n))))
{var vec__27859 = clustermap.formats.number.eng_notation.call(null,n,new cljs.core.Keyword(null,"sf","sf",-1949491738),sf);var sig = cljs.core.nth.call(null,vec__27859,(0),null);var exp = cljs.core.nth.call(null,vec__27859,(1),null);var abs_sig = Math.abs(sig);var suffix = clustermap.formats.money.money_suffix.call(null,exp);if((exp >= (0)))
...
return readable__delegate.call(this,n,p__27855);};
readable.cljs$lang$maxFixedArity = 1;
readable.cljs$lang$applyTo = (function (arglist__27860){
var n = cljs.core.first(arglist__27860);
var p__27855 = cljs.core.rest(arglist__27860);
return readable__delegate(n,p__27855);
});
