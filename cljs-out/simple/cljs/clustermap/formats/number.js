...
div_BANG_.cljs$lang$applyTo = (function (arglist__20424){
var num = cljs.core.first(arglist__20424);
...
_STAR__BANG_.cljs$lang$applyTo = (function (arglist__20425){
var args = cljs.core.seq(arglist__20425);
...
_PLUS__BANG_.cljs$lang$applyTo = (function (arglist__20426){
var args = cljs.core.seq(arglist__20426);
...
__BANG_.cljs$lang$applyTo = (function (arglist__20427){
...
return (function (p__20434){var vec__20435 = p__20434;var i = cljs.core.nth.call(null,vec__20435,(0),null);var v = cljs.core.nth.call(null,vec__20435,(1),null);if((n <= v))
{return i;
} else
{return null;
}
...
var table_chooser_fn__3 = (function (table,vals,p__20436){var map__20442 = p__20436;var map__20442__$1 = ((cljs.core.seq_QMARK_.call(null,map__20442))?cljs.core.apply.call(null,cljs.core.hash_map,map__20442):map__20442);var default$ = cljs.core.get.call(null,map__20442__$1,new cljs.core.Keyword(null,"default","default",-1987822328));var vals__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.sort.call(null,vals));var c = cljs.core.count.call(null,vals__$1);var idxs = cljs.core.map.call(null,((function (vals__$1,c,map__20442,map__20442__$1,default$){
return (function (tv){return ((tv * c) | (0));
});})(vals__$1,c,map__20442,map__20442__$1,default$))
,cljs.core.sort.call(null,table));var ts = cljs.core.map.call(null,((function (vals__$1,c,idxs,map__20442,map__20442__$1,default$){
return (function (idx){return cljs.core.get.call(null,vals__$1,idx);
});})(vals__$1,c,idxs,map__20442,map__20442__$1,default$))
,idxs);var i_ts = cljs.core.keep_indexed.call(null,cljs.core.vector,ts);return ((function (vals__$1,c,idxs,ts,i_ts,map__20442,map__20442__$1,default$){
return (function (val){if(cljs.core.truth_(val))
{var or__3639__auto__ = cljs.core.some.call(null,((function (vals__$1,c,idxs,ts,i_ts,map__20442,map__20442__$1,default$){
return (function (p__20445){var vec__20446 = p__20445;var i = cljs.core.nth.call(null,vec__20446,(0),null);var t = cljs.core.nth.call(null,vec__20446,(1),null);if((val < t))
{return i;
} else
{return null;
}
});})(vals__$1,c,idxs,ts,i_ts,map__20442,map__20442__$1,default$))
...
table_chooser_fn = function(table,vals,p__20436){
switch(arguments.length){
case 2:
return table_chooser_fn__2.call(this,table,vals);
case 3:
return table_chooser_fn__3.call(this,table,vals,p__20436);
}
...
clustermap.formats.number.split_thousands = (function split_thousands(n_str){return clojure.string.join.call(null,",",cljs.core.map.call(null,(function (p1__20447_SHARP_){return cljs.core.apply.call(null,cljs.core.str,p1__20447_SHARP_);
...
var eng_notation__delegate = function (n,p__20448){var map__20453 = p__20448;var map__20453__$1 = ((cljs.core.seq_QMARK_.call(null,map__20453))?cljs.core.apply.call(null,cljs.core.hash_map,map__20453):map__20453);var sf = cljs.core.get.call(null,map__20453__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738));if(cljs.core.truth_(n))
{var sign = (((n > (0)))?(1):((cljs.core._EQ_.call(null,n,(0)))?(0):(((n < (0)))?(-1):null)));var abs_n = Math.abs(n);var vec__20454 = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(abs_n)).split(".");var i = cljs.core.nth.call(null,vec__20454,(0),null);var d = cljs.core.nth.call(null,vec__20454,(1),null);var exp = (((abs_n >= (1)))?((3) * (((cljs.core.count.call(null,i) - (1)) / (3)) | (0))):(((abs_n > (0)))?((-3) * ((((3) + cljs.core.count.call(null,cljs.core.take_while.call(null,((function (sign,abs_n,vec__20454,i,d,map__20453,map__20453__$1,sf){
return (function (c){return cljs.core._EQ_.call(null,c,"0");
});})(sign,abs_n,vec__20454,i,d,map__20453,map__20453__$1,sf))
,d))) / (3)) | (0))):(0)
));var usig = (abs_n * Math.pow((10),((-1) * exp)));var vec__20455 = (cljs.core.truth_(sf)?(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(usig)).split("."):null);var usig_i = cljs.core.nth.call(null,vec__20455,(0),null);var usig_d = cljs.core.nth.call(null,vec__20455,(1),null);var sigmult = (cljs.core.truth_((function (){var and__3627__auto__ = sf;if(cljs.core.truth_(and__3627__auto__))
{return (usig > (0));
} else
{return and__3627__auto__;
}
})())?Math.pow((10),(cljs.core.count.call(null,usig_i) - sf)):null);var round_usig_str = (cljs.core.truth_(sigmult)?(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1((sigmult * Math.round((usig / sigmult))))):null);var vec__20456 = (cljs.core.truth_(round_usig_str)?round_usig_str.split("."):null);var round_usig_i = cljs.core.nth.call(null,vec__20456,(0),null);var round_usig_d = cljs.core.nth.call(null,vec__20456,(1),null);var trunc_usig_str = (cljs.core.truth_(round_usig_str)?cljs.core.apply.call(null,cljs.core.str,cljs.core.concat.call(null,cljs.core.filter.call(null,cljs.core.identity,cljs.core.flatten.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.take.call(null,sf,round_usig_i),cljs.core.repeat.call(null,(cljs.core.count.call(null,round_usig_i) - sf),"0"),(((cljs.core.count.call(null,round_usig_d) > (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [".",cljs.core.take.call(null,(sf - cljs.core.count.call(null,round_usig_i)),round_usig_d)], null):null)], null))))):null);var trunc_usig = (cljs.core.truth_(trunc_usig_str)?parseFloat(trunc_usig_str):null);var sig = (sign * (function (){var or__3639__auto__ = trunc_usig;if(cljs.core.truth_(or__3639__auto__))
{return or__3639__auto__;
} else
{return usig;
}
...
var p__20448 = null;if (arguments.length > 1) {
  p__20448 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return eng_notation__delegate.call(this,n,p__20448);};
eng_notation.cljs$lang$maxFixedArity = 1;
eng_notation.cljs$lang$applyTo = (function (arglist__20457){
var n = cljs.core.first(arglist__20457);
var p__20448 = cljs.core.rest(arglist__20457);
return eng_notation__delegate(n,p__20448);
});
...
var readable__2 = (function (n,p__20458){var map__20461 = p__20458;var map__20461__$1 = ((cljs.core.seq_QMARK_.call(null,map__20461))?cljs.core.apply.call(null,cljs.core.hash_map,map__20461):map__20461);var default$ = cljs.core.get.call(null,map__20461__$1,new cljs.core.Keyword(null,"default","default",-1987822328),"");var curr = cljs.core.get.call(null,map__20461__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"");var plus_QMARK_ = cljs.core.get.call(null,map__20461__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327),false);var dec = cljs.core.get.call(null,map__20461__$1,new cljs.core.Keyword(null,"dec","dec",1888433436),(0));if(clustermap.formats.number.actually_really_number_QMARK_.call(null,n))
{var abs_n = Math.abs(n);var round_n = clustermap.formats.number.round_decimal.call(null,abs_n,dec);var round_n_str = (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(round_n));var vec__20462 = clojure.string.split.call(null,round_n_str,/\./);var i_str = cljs.core.nth.call(null,vec__20462,(0),null);var d_str = cljs.core.nth.call(null,vec__20462,(1),null);var t_str = clustermap.formats.number.split_thousands.call(null,i_str);var t_dec_str = clojure.string.join.call(null,".",cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t_str,d_str], null)));return cljs.core.apply.call(null,cljs.core.str,cljs.core.filter.call(null,cljs.core.identity,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var and__3627__auto__ = plus_QMARK_;if(cljs.core.truth_(and__3627__auto__))
{return (n > (0));
} else
{return and__3627__auto__;
}
...
readable = function(n,p__20458){
switch(arguments.length){
case 1:
return readable__1.call(this,n);
case 2:
return readable__2.call(this,n,p__20458);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
eng_readable = function(n,p__20463){
switch(arguments.length){
case 1:
return eng_readable__1.call(this,n);
case 2:
return eng_readable__2.call(this,n,p__20463);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var mixed__2 = (function (n,p__20468){var map__20470 = p__20468;var map__20470__$1 = ((cljs.core.seq_QMARK_.call(null,map__20470))?cljs.core.apply.call(null,cljs.core.hash_map,map__20470):map__20470);var opts = map__20470__$1;var sf = cljs.core.get.call(null,map__20470__$1,new cljs.core.Keyword(null,"sf","sf",-1949491738),(3));var threshold = cljs.core.get.call(null,map__20470__$1,new cljs.core.Keyword(null,"threshold","threshold",204221583),(1000000));var dec = cljs.core.get.call(null,map__20470__$1,new cljs.core.Keyword(null,"dec","dec",1888433436),(0));var curr = cljs.core.get.call(null,map__20470__$1,new cljs.core.Keyword(null,"curr","curr",-1092372808),"");var plus_QMARK_ = cljs.core.get.call(null,map__20470__$1,new cljs.core.Keyword(null,"plus?","plus?",-3051327),false);var default$ = cljs.core.get.call(null,map__20470__$1,new cljs.core.Keyword(null,"default","default",-1987822328),"");if(clustermap.formats.number.actually_really_number_QMARK_.call(null,n))
{if((n < threshold))
...
mixed = function(n,p__20468){
switch(arguments.length){
case 1:
return mixed__1.call(this,n);
case 2:
return mixed__2.call(this,n,p__20468);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
