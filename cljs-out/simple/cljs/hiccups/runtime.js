...
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_33048 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_33048;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__33049){var vec__33051 = p__33049;var name = cljs.core.nth.call(null,vec__33051,(0),null);var value = cljs.core.nth.call(null,vec__33051,(1),null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__33052){var vec__33055 = p__33052;var tag = cljs.core.nth.call(null,vec__33055,(0),null);var content = cljs.core.nthnext.call(null,vec__33055,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
{throw (''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)+" is not a valid tag name");
} else
{}
var vec__33056 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));var _ = cljs.core.nth.call(null,vec__33056,(0),null);var tag__$1 = cljs.core.nth.call(null,vec__33056,(1),null);var id = cljs.core.nth.call(null,vec__33056,(2),null);var class$ = cljs.core.nth.call(null,vec__33056,(3),null);var tag_attrs = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),(cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,"."," "):null)], null);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__33058 = hiccups.runtime.normalize_element.call(null,element);var tag = cljs.core.nth.call(null,vec__33058,(0),null);var attrs = cljs.core.nth.call(null,vec__33058,(1),null);var content = cljs.core.nth.call(null,vec__33058,(2),null);if(cljs.core.truth_((function (){var or__3639__auto__ = content;if(cljs.core.truth_(or__3639__auto__))
