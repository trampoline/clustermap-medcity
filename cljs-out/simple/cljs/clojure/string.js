...
{{
var G__27798 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27798;
continue;
}
} else
...
{var pred__27802 = cljs.core._EQ_;var expr__27803 = limit;if(cljs.core.truth_(pred__27802.call(null,(1),expr__27803)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27802.call(null,(2),expr__27803)))
...
var G__27805 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27806 = (limit__$1 - (1));
var G__27807 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27805;
limit__$1 = G__27806;
parts = G__27807;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27809 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27809))
{var replacement_27810 = temp__4124__auto___27809;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27810)));
} else
{buffer.append(ch);
}
{
var G__27811 = (index + (1));
index = G__27811;
continue;
}
}
