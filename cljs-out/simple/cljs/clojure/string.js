...
{{
var G__27810 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27810;
continue;
}
} else
...
{var pred__27814 = cljs.core._EQ_;var expr__27815 = limit;if(cljs.core.truth_(pred__27814.call(null,(1),expr__27815)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27814.call(null,(2),expr__27815)))
...
var G__27817 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27818 = (limit__$1 - (1));
var G__27819 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27817;
limit__$1 = G__27818;
parts = G__27819;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27821 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27821))
{var replacement_27822 = temp__4124__auto___27821;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27822)));
} else
{buffer.append(ch);
}
{
var G__27823 = (index + (1));
index = G__27823;
continue;
}
}
