...
{{
var G__27815 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27815;
continue;
}
} else
...
{var pred__27819 = cljs.core._EQ_;var expr__27820 = limit;if(cljs.core.truth_(pred__27819.call(null,(1),expr__27820)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27819.call(null,(2),expr__27820)))
...
var G__27822 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27823 = (limit__$1 - (1));
var G__27824 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27822;
limit__$1 = G__27823;
parts = G__27824;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27826 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27826))
{var replacement_27827 = temp__4124__auto___27826;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27827)));
} else
{buffer.append(ch);
}
{
var G__27828 = (index + (1));
index = G__27828;
continue;
}
}
