...
{{
var G__27819 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27819;
continue;
}
} else
...
{var pred__27823 = cljs.core._EQ_;var expr__27824 = limit;if(cljs.core.truth_(pred__27823.call(null,(1),expr__27824)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27823.call(null,(2),expr__27824)))
...
var G__27826 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27827 = (limit__$1 - (1));
var G__27828 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__27826;
limit__$1 = G__27827;
parts = G__27828;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___27830 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___27830))
{var replacement_27831 = temp__4124__auto___27830;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27831)));
} else
{buffer.append(ch);
}
{
var G__27832 = (index + (1));
index = G__27832;
continue;
}
}
