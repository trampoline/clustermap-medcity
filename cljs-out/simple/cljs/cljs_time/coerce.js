...
goog.require('cljs_time.format');
goog.require('cljs_time.core');
cljs_time.coerce.ICoerce = (function (){var obj27679 = {};return obj27679;
})();
...
*/
cljs_time.coerce.from_long = (function from_long(millis){var G__27681 = (new goog.date.UtcDateTime());G__27681.setTime(millis);
return G__27681;
});
/**
...
*/
cljs_time.coerce.from_string = (function from_string(s){return cljs.core.first.call(null,(function (){var iter__4377__auto__ = (function iter__27690(s__27691){return (new cljs.core.LazySeq(null,(function (){var s__27691__$1 = s__27691;while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__27691__$1);if(temp__4126__auto__)
{var s__27691__$2 = temp__4126__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__27691__$2))
...
{var f = cljs.core._nth.call(null,c__4375__auto__,i__27692);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e27696){if((e27696 instanceof Error))
{var _ = e27696;return null;
} else
{throw e27696;

}
}})();if(cljs.core.truth_(d))
{cljs.core.chunk_append.call(null,b__27693,d);
{
...
{var f = cljs.core.first.call(null,s__27691__$2);var d = (function (){try{return cljs_time.format.parse.call(null,f,s);
}catch (e27697){if((e27697 instanceof Error))
{var _ = e27697;return null;
} else
{throw e27697;

}
}})();if(cljs.core.truth_(d))
{return cljs.core.cons.call(null,d,iter__27690.call(null,cljs.core.rest.call(null,s__27691__$2)));
} else
{{
var G__27700 = cljs.core.rest.call(null,s__27691__$2);
s__27691__$1 = G__27700;
continue;
}
}
}
...
{var dt = temp__4124__auto__;var G__27702 = (new goog.date.DateTime(dt.getYear(),dt.getMonth(),dt.getDate()));G__27702.setHours(dt.getHours());
G__27702.setMinutes(dt.getMinutes());
G__27702.setSeconds(dt.getSeconds());
G__27702.setMilliseconds(dt.getMilliseconds());
return G__27702;
} else
{return null;
}
