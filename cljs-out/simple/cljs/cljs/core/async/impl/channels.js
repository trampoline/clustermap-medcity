...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t26698 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t26698 = (function (val,box,meta26699){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t26698.cljs$lang$type = true;
cljs.core.async.impl.channels.t26698.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t26698";
cljs.core.async.impl.channels.t26698.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"cljs.core.async.impl.channels/t26698");
});
cljs.core.async.impl.channels.t26698.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t26698.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26700){var self__ = this;
var _26700__$1 = this;return self__.meta26699;
});
cljs.core.async.impl.channels.t26698.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26700,meta26699__$1){var self__ = this;
var _26700__$1 = this;return (new cljs.core.async.impl.channels.t26698(self__.val,self__.box,meta26699__$1));
});
cljs.core.async.impl.channels.__GT_t26698 = (function __GT_t26698(val__$1,box__$1,meta26699){return (new cljs.core.async.impl.channels.t26698(val__$1,box__$1,meta26699));
});
}
return (new cljs.core.async.impl.channels.t26698(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj26702 = {};return obj26702;
})();
...
{}
while(true){
var taker_26703 = self__.takes.pop();if((taker_26703 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_26703))
{var take_cb_26704 = cljs.core.async.impl.protocols.commit.call(null,taker_26703);var val_26705 = (cljs.core.truth_((function (){var and__3627__auto__ = self__.buf;if(cljs.core.truth_(and__3627__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3627__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_26704,val_26705,taker_26703,this$__$1){
return (function (){return take_cb_26704.call(null,val_26705);
});})(take_cb_26704,val_26705,taker_26703,this$__$1))
);
} else
{}
{
...
{} else
{var putter_26706 = self__.puts.pop();if((putter_26706 == null))
{} else
{var put_handler_26707 = putter_26706.handler;var val_26708 = putter_26706.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_26707))
{var put_cb_26709 = cljs.core.async.impl.protocols.commit.call(null,put_handler_26707);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_26709,put_handler_26707,val_26708,putter_26706,_,retval,this$__$1){
return (function (){return put_cb_26709.call(null,true);
});})(put_cb_26709,put_handler_26707,val_26708,putter_26706,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_26708)))
...
{var taker_26710 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_26710))
{var take_cb_26711 = cljs.core.async.impl.protocols.commit.call(null,taker_26710);var val_26712__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_26711,val_26712__$1,taker_26710,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_26711.call(null,val_26712__$1);
});})(take_cb_26711,val_26712__$1,taker_26710,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_26713 = self__.puts.pop();if((putter_26713 == null))
{} else
{var put_handler_26714 = putter_26713.handler;var val_26715 = putter_26713.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_26714))
{var put_cb_26716 = cljs.core.async.impl.protocols.commit.call(null,put_handler_26714);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_26716,put_handler_26714,val_26715,putter_26713,this$__$1){
return (function (){return put_cb_26716.call(null,true);
...
return (function() {
var G__26721 = null;
var G__26721__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e26719){var t = e26719;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__26721__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e26720){var t = e26720;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__26721 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__26721__1.call(this,buf__$1);
case 2:
return G__26721__2.call(this,buf__$1,val);
}
