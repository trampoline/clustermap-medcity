...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t26694 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t26694 = (function (val,box,meta26695){
this.val = val;
this.box = box;
this.meta26695 = meta26695;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t26694.cljs$lang$type = true;
cljs.core.async.impl.channels.t26694.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t26694";
cljs.core.async.impl.channels.t26694.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"cljs.core.async.impl.channels/t26694");
});
cljs.core.async.impl.channels.t26694.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t26694.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26696){var self__ = this;
var _26696__$1 = this;return self__.meta26695;
});
cljs.core.async.impl.channels.t26694.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26696,meta26695__$1){var self__ = this;
var _26696__$1 = this;return (new cljs.core.async.impl.channels.t26694(self__.val,self__.box,meta26695__$1));
});
cljs.core.async.impl.channels.__GT_t26694 = (function __GT_t26694(val__$1,box__$1,meta26695){return (new cljs.core.async.impl.channels.t26694(val__$1,box__$1,meta26695));
});
}
return (new cljs.core.async.impl.channels.t26694(val,box,null));
});
...
cljs.core.async.impl.channels.MMC = (function (){var obj26698 = {};return obj26698;
})();
...
{}
while(true){
var taker_26699 = self__.takes.pop();if((taker_26699 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_26699))
{var take_cb_26700 = cljs.core.async.impl.protocols.commit.call(null,taker_26699);var val_26701 = (cljs.core.truth_((function (){var and__3627__auto__ = self__.buf;if(cljs.core.truth_(and__3627__auto__))
{return (cljs.core.count.call(null,self__.buf) > (0));
} else
{return and__3627__auto__;
}
})())?cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf):null);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_26700,val_26701,taker_26699,this$__$1){
return (function (){return take_cb_26700.call(null,val_26701);
});})(take_cb_26700,val_26701,taker_26699,this$__$1))
);
} else
{}
{
...
{} else
{var putter_26702 = self__.puts.pop();if((putter_26702 == null))
{} else
{var put_handler_26703 = putter_26702.handler;var val_26704 = putter_26702.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_26703))
{var put_cb_26705 = cljs.core.async.impl.protocols.commit.call(null,put_handler_26703);cljs.core.async.impl.protocols.commit.call(null,handler);
cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_26705,put_handler_26703,val_26704,putter_26702,_,retval,this$__$1){
return (function (){return put_cb_26705.call(null,true);
});})(put_cb_26705,put_handler_26703,val_26704,putter_26702,_,retval,this$__$1))
);
if(cljs.core.reduced_QMARK_.call(null,self__.add_BANG_.call(null,self__.buf,val_26704)))
...
{var taker_26706 = self__.takes.pop();if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_26706))
{var take_cb_26707 = cljs.core.async.impl.protocols.commit.call(null,taker_26706);var val_26708__$1 = cljs.core.async.impl.protocols.remove_BANG_.call(null,self__.buf);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_26707,val_26708__$1,taker_26706,done_QMARK_,closed__$1,this$__$1){
return (function (){return take_cb_26707.call(null,val_26708__$1);
});})(take_cb_26707,val_26708__$1,taker_26706,done_QMARK_,closed__$1,this$__$1))
);
} else
{{
continue;
...
var putter_26709 = self__.puts.pop();if((putter_26709 == null))
{} else
{var put_handler_26710 = putter_26709.handler;var val_26711 = putter_26709.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_26710))
{var put_cb_26712 = cljs.core.async.impl.protocols.commit.call(null,put_handler_26710);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_26712,put_handler_26710,val_26711,putter_26709,this$__$1){
return (function (){return put_cb_26712.call(null,true);
});})(put_cb_26712,put_handler_26710,val_26711,putter_26709,this$__$1))
);
} else
{{
continue;
...
return (function() {
var G__26717 = null;
var G__26717__1 = (function (buf__$1){try{return add_BANG_.call(null,buf__$1);
}catch (e26715){var t = e26715;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
var G__26717__2 = (function (buf__$1,val){try{return add_BANG_.call(null,buf__$1,val);
}catch (e26716){var t = e26716;return cljs.core.async.impl.channels.handle.call(null,buf__$1,exh,t);
}});
G__26717 = function(buf__$1,val){
switch(arguments.length){
case 1:
return G__26717__1.call(this,buf__$1);
case 2:
return G__26717__2.call(this,buf__$1,val);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__26717.cljs$core$IFn$_invoke$arity$1 = G__26717__1;
