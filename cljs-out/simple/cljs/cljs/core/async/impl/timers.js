...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_26603 = (0);while(true){
if((i_26603 < arr.length))
{(arr[i_26603] = null);
{
...
{var i_26610 = (self__.level + (1));while(true){
if((i_26610 <= (new_level + (1))))
{(update[i_26610] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_26612 = (0);while(true){
if((i_26612 <= self__.level))
{var links_26613 = (update[i_26612]).forward;if(((links_26613[i_26612]) === x__$1))
{(links_26613[i_26612] = (x__$1.forward[i_26612]));
{
var G__26614 = (i_26612 + (1));
i_26612 = G__26614;
continue;
}
} else
{{
var G__26615 = (i_26612 + (1));
i_26612 = G__26615;
continue;
}
}
