...
{{
var G__29493 = (i + (1));
var G__29494 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__29493;
acc = G__29494;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t29498 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t29498 = (function (expr,base,xpath,meta29499){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t29498.cljs$lang$type = true;
domina.xpath.t29498.cljs$lang$ctorStr = "domina.xpath/t29498";
domina.xpath.t29498.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t29498");
});
domina.xpath.t29498.prototype.domina$DomContent$ = true;
domina.xpath.t29498.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29498.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29498.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29500){var self__ = this;
var _29500__$1 = this;return self__.meta29499;
});
domina.xpath.t29498.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29500,meta29499__$1){var self__ = this;
var _29500__$1 = this;return (new domina.xpath.t29498(self__.expr,self__.base,self__.xpath,meta29499__$1));
});
domina.xpath.__GT_t29498 = (function __GT_t29498(expr__$1,base__$1,xpath__$1,meta29499){return (new domina.xpath.t29498(expr__$1,base__$1,xpath__$1,meta29499));
});
}
return (new domina.xpath.t29498(expr,base,xpath,null));
});
