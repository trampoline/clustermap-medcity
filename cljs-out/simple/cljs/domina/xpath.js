...
{{
var G__29524 = (i + (1));
var G__29525 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__29524;
acc = G__29525;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t29529 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t29529 = (function (expr,base,xpath,meta29530){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t29529.cljs$lang$type = true;
domina.xpath.t29529.cljs$lang$ctorStr = "domina.xpath/t29529";
domina.xpath.t29529.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t29529");
});
domina.xpath.t29529.prototype.domina$DomContent$ = true;
domina.xpath.t29529.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29529.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29529.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29531){var self__ = this;
var _29531__$1 = this;return self__.meta29530;
});
domina.xpath.t29529.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29531,meta29530__$1){var self__ = this;
var _29531__$1 = this;return (new domina.xpath.t29529(self__.expr,self__.base,self__.xpath,meta29530__$1));
});
domina.xpath.__GT_t29529 = (function __GT_t29529(expr__$1,base__$1,xpath__$1,meta29530){return (new domina.xpath.t29529(expr__$1,base__$1,xpath__$1,meta29530));
});
}
return (new domina.xpath.t29529(expr,base,xpath,null));
});
