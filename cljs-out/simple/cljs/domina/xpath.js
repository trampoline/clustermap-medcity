...
{{
var G__29490 = (i + (1));
var G__29491 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__29490;
acc = G__29491;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t29495 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t29495 = (function (expr,base,xpath,meta29496){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t29495.cljs$lang$type = true;
domina.xpath.t29495.cljs$lang$ctorStr = "domina.xpath/t29495";
domina.xpath.t29495.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t29495");
});
domina.xpath.t29495.prototype.domina$DomContent$ = true;
domina.xpath.t29495.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29495.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29495.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29497){var self__ = this;
var _29497__$1 = this;return self__.meta29496;
});
domina.xpath.t29495.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29497,meta29496__$1){var self__ = this;
var _29497__$1 = this;return (new domina.xpath.t29495(self__.expr,self__.base,self__.xpath,meta29496__$1));
});
domina.xpath.__GT_t29495 = (function __GT_t29495(expr__$1,base__$1,xpath__$1,meta29496){return (new domina.xpath.t29495(expr__$1,base__$1,xpath__$1,meta29496));
});
}
return (new domina.xpath.t29495(expr,base,xpath,null));
});
