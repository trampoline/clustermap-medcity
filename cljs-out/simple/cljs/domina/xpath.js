...
{{
var G__29533 = (i + (1));
var G__29534 = cljs.core.cons.call(null,result.snapshotItem(i),acc);
i = G__29533;
acc = G__29534;
continue;
}
...
var xpath__2 = (function (base,expr){if(typeof domina.xpath.t29538 !== 'undefined')
{} else
{
/**
* @constructor
*/
domina.xpath.t29538 = (function (expr,base,xpath,meta29539){
this.expr = expr;
this.base = base;
this.xpath = xpath;
...
domina.xpath.t29538.cljs$lang$type = true;
domina.xpath.t29538.cljs$lang$ctorStr = "domina.xpath/t29538";
domina.xpath.t29538.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"domina.xpath/t29538");
});
domina.xpath.t29538.prototype.domina$DomContent$ = true;
domina.xpath.t29538.prototype.domina$DomContent$nodes$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29538.prototype.domina$DomContent$single_node$arity$1 = (function (_){var self__ = this;
...
domina.xpath.t29538.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29540){var self__ = this;
var _29540__$1 = this;return self__.meta29539;
});
domina.xpath.t29538.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29540,meta29539__$1){var self__ = this;
var _29540__$1 = this;return (new domina.xpath.t29538(self__.expr,self__.base,self__.xpath,meta29539__$1));
});
domina.xpath.__GT_t29538 = (function __GT_t29538(expr__$1,base__$1,xpath__$1,meta29539){return (new domina.xpath.t29538(expr__$1,base__$1,xpath__$1,meta29539));
});
}
return (new domina.xpath.t29538(expr,base,xpath,null));
});
